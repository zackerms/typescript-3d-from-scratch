...
describe("Vector3", () => {
  ...
  describe("subtract", () => {
    it("should subtract two vectors correctly", () => {
      const v1 = new Vector3({ x: 4, y: 5, z: 6 });
      const v2 = new Vector3({ x: 1, y: 2, z: 3 });
  ...
  describe("cross", () => {
    it("should calculate cross product correctly", () => {
      const v1 = new Vector3({ x: 1, y: 0, z: 0 });
      const v2 = new Vector3({ x: 0, y: 1, z: 0 });
  ...
  describe("length", () => {
    it("should calculate vector length correctly", () => {
      const v = new Vector3({ x: 3, y: 4, z: 0 });
  ...
  describe("normalize", () => {
    it("should normalize vector correctly", () => {
      const v = new Vector3({ x: 3, y: 0, z: 0 });
    ...
    it("should handle zero vector correctly", () => {
      const v = new Vector3({ x: 0, y: 0, z: 0 });
      const result = v.normalize();
      expect(result.x).toBe(0);
      expect(result.y).toBe(0);
      expect(result.z).toBe(0);
